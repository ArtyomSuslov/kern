...
#include <inc/digit_table.h>
#include <inc/d2fixed_full_table.h>
#include <inc/d2s_intrinsics.h>
...
void d2fixed(double d, uint32_t precision, char *buffer) {
...
void d2exp(double d, uint32_t precision, char *buffer) {
